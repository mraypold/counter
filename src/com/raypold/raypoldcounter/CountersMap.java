...
public class CountersMap implements Serializable {
	...
	/*
	 * Intended to be used during creation of new counters from the action bar
	 * so as to not overwrite .dat serialized class files.
	 */
	...
	public ArrayList<String> getOrderedList() {
		...
		/*
		 * Add the next largest counter to the orderedCounters array until none
		 * left
		 */
		while (size > 0) {
